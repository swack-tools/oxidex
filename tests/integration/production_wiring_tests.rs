//! Production parser/writer wiring regression tests.
//!
//! These tests exercise the real production entrypoints
//! (`oxidex::core::operations::read_metadata` / `write_metadata`) rather than
//! calling parser functions directly. They guard against regressions where an
//! implemented parser/writer is not reachable through the public API.
