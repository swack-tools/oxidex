...
/// offsets by" 246 (`LONG_ARTIST`) and -32 (`-IFD0:Software=`) -- on
/// t/images/ExifTool.jpg, whose trailers are AFCP, two FotoStation records,
/// CanonVRD, PhotoMechanic, MIE, Samsung and Vivo. `-all=` deletes the
/// trailer (below). That file's MIE trailer makes pinned 13.59 write every
/// EXIF set into MIE's own EXIF directory too, which oxidex refuses
