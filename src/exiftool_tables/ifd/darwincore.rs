//! ExifTool `DarwinCore` IFD-style tables, generated from ExifTool
...
pub static IFD_DARWINCORE_MAIN: IfdTable = IfdTable {
    ...
    priority: None,
    gate_a: GateA {
        blocked_by: &[("ifd_tag_id_unrepresentable", 37)],
    },
    tags: &[],
    variants: &[],
};
