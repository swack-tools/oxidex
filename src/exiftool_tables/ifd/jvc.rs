//! ExifTool `JVC` IFD-style tables, generated from ExifTool
...
pub static IFD_JVC_MAIN: IfdTable = IfdTable {
    ...
    tags: &[
        ...
        IfdTag {
            ...
            raw_conv: None,
            value_conv: None,
            print_conv: PrintConv::IntEnum(&[(0, "Low"), (1, "Normal"), (2, "Fine")]),
            subdir: None,
        },
    ],
    variants: &[],
