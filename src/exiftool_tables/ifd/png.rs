//! ExifTool `PNG` IFD-style tables, generated from ExifTool
...
pub static IFD_PNG_MAIN: IfdTable = IfdTable {
    ...
    priority: None,
    gate_a: GateA {
        blocked_by: &[("ifd_tag_id_unrepresentable", 38)],
    },
    tags: &[],
    variants: &[],
};
