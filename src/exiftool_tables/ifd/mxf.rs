//! ExifTool `MXF` IFD-style tables, generated from ExifTool
...
pub static IFD_MXF_MAIN: IfdTable = IfdTable {
    ...
    priority: None,
    gate_a: GateA {
        blocked_by: &[("ifd_tag_id_unrepresentable", 1652)],
    },
    tags: &[],
    variants: &[],
};
