//! ExifTool `OpenEXR` IFD-style tables, generated from ExifTool
...
pub static IFD_OPENEXR_MAIN: IfdTable = IfdTable {
    ...
    priority: None,
    gate_a: GateA {
        blocked_by: &[("ifd_tag_id_unrepresentable", 41)],
    },
    tags: &[],
    variants: &[],
};
