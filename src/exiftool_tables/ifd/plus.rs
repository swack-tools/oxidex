//! ExifTool `PLUS` IFD-style tables, generated from ExifTool
...
pub static IFD_PLUS_XMP: IfdTable = IfdTable {
    ...
    priority: None,
    gate_a: GateA {
        blocked_by: &[("ifd_tag_id_unrepresentable", 62)],
    },
    tags: &[],
    variants: &[],
};
