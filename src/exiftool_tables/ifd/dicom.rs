//! ExifTool `DICOM` IFD-style tables, generated from ExifTool
...
pub static IFD_DICOM_MAIN: IfdTable = IfdTable {
    ...
    priority: None,
    gate_a: GateA {
        blocked_by: &[("ifd_tag_id_unrepresentable", 5669)],
    },
    tags: &[],
    variants: &[],
};
