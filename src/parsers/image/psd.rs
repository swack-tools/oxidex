...
impl PSDParser {
    ...
    ///
    /// The shared IIM walk applies IPTC.pm's formats and PrintConvs and
    /// accumulates the datasets ExifTool reports as lists, so a PSD's IPTC
    /// reads the same as the identical bytes in a JPEG or TIFF.
