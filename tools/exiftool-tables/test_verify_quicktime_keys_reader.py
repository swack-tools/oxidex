...
class T(unittest.TestCase):
 ...
 def test_report_rejects_forged_projection(self):
  row={'fixture':'x','native_json':'[{"SourceFile":"x","Keys:Artist":"Ada"}]','oxidex_json':'[{"SourceFile":"x","Keys:Artist":"Ada"}]','native_json_sha256':'','oxidex_json_sha256':'','expected':{},'actual':{},'matched':True}
