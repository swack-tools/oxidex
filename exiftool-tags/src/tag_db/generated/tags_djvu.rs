...
static TAGS: Lazy<Vec<TagDescriptor>> = Lazy::new(|| {
    vec![
        ...
        TagDescriptor::new(
            ...
            false,
            ValueType::String,
            "SpatialResolution tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "DjVu:Rotate 180".to_string(),
            FormatFamily::PNG,
            false,
            ValueType::String,
            "Rotate 180 tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0005),
            "DjVu:Rotate 90 CW".to_string(),
            FormatFamily::PNG,
            false,
            ValueType::String,
            "Rotate 90 CW tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0006),
            "DjVu:Rotate 270 CW".to_string(),
            FormatFamily::PNG,
            false,
            ValueType::String,
            "Rotate 270 CW tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
