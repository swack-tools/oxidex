...
static TAGS: Lazy<Vec<TagDescriptor>> = Lazy::new(|| {
    vec![
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "GPS:3-Dimensional Measurement".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:Differential Corrected".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            false,
            ValueType::String,
            "GPSHPositioningError tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:GPS:GPSTimeStamp".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "GPS:GPSTimeStamp tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:GPS:GPSLatitudeRef".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "GPS:GPSLatitudeRef tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:GPS:GPSLongitudeRef".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "GPS:GPSLongitudeRef tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:GPS:GPSAltitudeRef".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "GPS:GPSAltitudeRef tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "GPS:XMP:GPSAltitude".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "XMP:GPSAltitude tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "GPS:XMP:GPSAltitudeRef".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "XMP:GPSAltitudeRef tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:GPS:GPSDestLatitudeRef".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "GPS:GPSDestLatitudeRef tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "GPS:GPS:GPSDestLongitudeRef".to_string(),
            FormatFamily::GPS,
            false,
            ValueType::String,
            "GPS:GPSDestLongitudeRef tag".to_string(),
            vec!["Example".to_string()],
        ),
    ]
});
