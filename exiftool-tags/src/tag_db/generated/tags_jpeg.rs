...
static TAGS: Lazy<Vec<TagDescriptor>> = Lazy::new(|| {
    vec![
        ...
        TagDescriptor::new(
            ...
            "JPEG:Half width".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Half width tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "JPEG:Left field first".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Left field first tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "JPEG:Left Eye".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "JPEG:Side By Side".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Side By Side tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "JPEG:Over Under".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Over Under tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "JPEG:Anaglyph".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Anaglyph tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "JPEG:Continuous-tone Base".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Continuous-tone Base tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "JPEG:Continuous-tone Progressive".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Continuous-tone Progressive tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "JPEG:Bi-level Facsimile".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Bi-level Facsimile tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "JPEG:Continuous-tone Facsimile".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Continuous-tone Facsimile tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "JPEG:YCbCr, ITU-R BT 709, video".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "YCbCr, ITU-R BT 709, video tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "JPEG:No color space specified".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "No color space specified tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "JPEG:YCbCr, ITU-R BT 601-1, RGB".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "YCbCr, ITU-R BT 601-1, RGB tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "JPEG:YCbCr, ITU-R BT 601-1, video".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "YCbCr, ITU-R BT 601-1, video tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0008),
            "JPEG:Gray-scale".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Gray-scale tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0009),
            "JPEG:PhotoYCC".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "JPEG:Modified Huffman".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "JPEG:Modified Modified READ".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0000),
            "JPEG:AdobeCMType".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "AdobeCMType tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0000),
            "JPEG:DCTEncodeVersion".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "DCTEncodeVersion tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "JPEG:Tactical Imagery".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Tactical Imagery tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x000A),
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "JPEG:Extended sequential DCT, Huffman coding, 12-bit samples".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "Extended sequential DCT, Huffman coding, 12-bit samples tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x000B),
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000D),
            "JPEG:StreamBitDepth".to_string(),
            FormatFamily::JPEG,
            false,
            ValueType::String,
            "StreamBitDepth tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x000E),
