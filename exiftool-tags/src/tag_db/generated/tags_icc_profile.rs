...
static TAGS: Lazy<Vec<TagDescriptor>> = Lazy::new(|| {
    vec![
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:Media-Relative Colorimetric".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "Media-Relative Colorimetric tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "ICC_Profile:Saturation".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:ICC-Absolute Colorimetric".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "ICC-Absolute Colorimetric tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "ICC_Profile:Unspecified".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "ICC_Profile:BT.470 System M (historical)".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:BT.470 System B, G (historical)".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:SMPTE 240".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0008),
            "ICC_Profile:Generic film (color filters using illuminant C)".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:BT.2020, BT.2100".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000C),
            "ICC_Profile:SMPTE EG 432-1".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:EBU Tech. 3213-E".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
            "ICC_Profile:For future use (3)".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0007),
            "ICC_Profile:SMPTE 240 M".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0009),
            "ICC_Profile:Logarithmic (100 : 1 range)".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:Logarithmic (100 * Sqrt(10) : 1 range)".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:IEC 61966-2-4".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:sRGB or sYCC".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:BT.2020 10-bit systems".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:BT.2020 12-bit systems".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0010),
            "ICC_Profile:SMPTE ST 2084, ITU BT.2100 PQ".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:SMPTE ST 428".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            ...
            "ICC_Profile:BT.2100 HLG, ARIB STD-B67".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0004),
            "ICC_Profile:US FCC 73.628".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0009),
            "ICC_Profile:BT.2020 non-constant luminance, BT.2100 YCbCr".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000A),
            "ICC_Profile:BT.2020 constant luminance".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000B),
            "ICC_Profile:SMPTE ST 2085 YDzDx".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000C),
            "ICC_Profile:Chromaticity-derived non-constant luminance".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000D),
            "ICC_Profile:Chromaticity-derived constant luminance".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x000E),
            "ICC_Profile:BT.2100 ICtCp".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "ICC_Profile:CIE 1964".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "CIE 1964 tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x000C),
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "ICC_Profile:0/45 or 45/0".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "0/45 or 45/0 tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "ICC_Profile:0/d or d/0".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "0/d or d/0 tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
        ...
        TagDescriptor::new(
            TagId::new_numeric(0x0001),
            "ICC_Profile:ITU-R BT.709".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "ITU-R BT.709 tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0002),
            "ICC_Profile:SMPTE RP145-1994".to_string(),
            FormatFamily::ICCProfile,
            false,
            ValueType::String,
            "SMPTE RP145-1994 tag".to_string(),
            vec!["Example".to_string()],
        ),
        TagDescriptor::new(
            TagId::new_numeric(0x0003),
