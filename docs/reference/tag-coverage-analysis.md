...
::: info Auto-Generated
This document is automatically updated on each push to `main`. Last updated: **2026-08-04**
:::
...
MakerNote parsers for 31+ camera manufacturers are **fully implemented and connected** to the TIFF parsing pipeline.
:::
