...
| Sony raw-ID correctness repair | Paired 4,238-file comparison complete; full gate failed while compiling a supporting command; not landed | Correct rows rise from 468,002 to 468,012. Ten files gain ImageNumber; no new missing, wrong-value or extra facts. This is correctness progress. |
